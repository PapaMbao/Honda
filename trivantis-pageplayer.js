...
jsPagePlayer.prototype.gotoPage = function ( pageName, noHist )
{
	...
	if ( thePage == u )
		thePage = THIS.loadPage(pageName, function() {
			...
			if (is.iOS) THIS.ReFlow(); //LD-8539: Fixed anchor position objects disappearing issue on ios devices 
		});
	else{
...
jsPagePlayer.prototype.createVimeoPlayer = function (iframe)
{
	return jsOpaUtils.createVimeoPlayer(iframe);
};
