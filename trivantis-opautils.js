...
jsOpaUtils.createVimeoPlayer = function (iframe)
{
	...
	if(pageObj)
	{
		if(pageObj.iframe.contentWindow.bTrivResponsive)
		{
			...
			if(is.iOS)
			{
				...
				// LD-8360: Enhanced code stability by ensuring access to contentWindow only after full iframe loading.
				pageObj.iframe.addEventListener("load", function(){
